...
<template>
  <Card p="y-3 e-4 s-4 md:e-0 md:s-0 md:y-6" grid place-items-center rounded-xl hover:text-primary>
    <button grid h-full w-full md:place-items-center @click="$emit('onClick')">
